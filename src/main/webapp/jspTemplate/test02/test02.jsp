...
<body>
	...
	<div id = "wrap">
		...
		<section>
			<div class="border border-success d-flex justify-content-start">
			...
			<div>
				<span class="font-weight-bold"> 곡 목록</span>
				<br>
				<table class="table text-center">
					...
					<tbody>
						...
						%>	<tr>
								<td><a href="#"><%= musicMap.get("id") %></a></td>
								<td><a href="#"><%= musicMap.get("title") %></a></td>
								<td><a href="#"><%= musicMap.get("album") %></a></td>
							</tr>
						<%} %>
					</tbody>
				</table>
